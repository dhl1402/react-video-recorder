...
var Button = _styledComponents['default'].button.withConfig({
  ...
  [
    'background:',
    ';color:',
    ';border-radius:50%;width:64px;height:64px;background:rgba(227,73,28,0.8);outline:none;border:none;cursor:pointer;z-index:5;:hover{background:#fb6d42;}'
  ],
  function (props) {
...
var RecordButton = function RecordButton(_ref) {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement(
      ButtonBorder,
      null,
      /*#__PURE__*/ _react['default'].createElement(Button, props)
    )
  )
}
